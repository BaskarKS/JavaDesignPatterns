...
public class SpreadSheet {
  ...
  private CellFontDetailsFactory factory;

  private Cell[][] cells = new Cell[MAX_ROWS][MAX_COLS];

  public SpreadSheet(CellFontDetailsFactory factory) {
  ...
  public void setFontFamily(int row, int col, String fontFamily) {
    ...
    var currentFontDetails = cell.getFontDetails();
    var newFontDetails = factory.getCellFontDetails(fontFamily,
                      currentFontDetails.getFontSize(),
                      currentFontDetails.isBold());
    cells[row][col].setFontDetails(newFontDetails);
  }
  ...
  private void generateCells() {
    for (var row = 0; row < MAX_ROWS; row++)
      for (var col = 0; col < MAX_COLS; col++) {
        var cell = new Cell(row, col, factory.getCellFontDetails(
